...
void loop() 
{
  ...
  displayString("help"); // change here
}
...
void adjustSpeed()
{
  ...
  deltaxy = sqrt(pow(deltaxy,2)); //will reflect magnitute of acceleration rate of change
  ...
  {      
    ...
    {      
      ...
      if((xdata + ydata - 1000) < -80) // posibly play with the value for both this and else if statement
      {
          tick = millis();
          swingLeft = true;
          edgeTime = millis();
